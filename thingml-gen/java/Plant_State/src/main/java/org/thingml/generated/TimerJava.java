...
Handler h440295203 = new Handler();
h440295203.from(state_TimerJava_SoftTimer_default);
h440295203.event(timer_startType);
h440295203.guard((Event e)->{
...
h440295203.port(timer_port);
h440295203.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
...
sendTimer_timeout_via_timer((int) (1));
}};
